...
public final class SampleMainBinding implements ViewBinding {
  ...
  private SampleMainBinding(@NonNull ConstraintLayout rootView, @NonNull TextView introText,
      @NonNull ProgressBar loading, @NonNull RecyclerView mainRecyclerView) {
  ...
  public static SampleMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SampleMainBinding((ConstraintLayout) rootView, introText, loading,
          mainRecyclerView);
    }
